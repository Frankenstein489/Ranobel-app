...
[3] Sfx for jiggling/bouncing like jelly.

[4] Sfx for munching, eating something crunchy.

[5] Japanese wordgame, using the final kana of the first word for the basis of the next word and so on.
