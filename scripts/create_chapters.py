...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print('Usage: python3 scripts/create_chapters.py <novel-id> [count]')
        print()
        print('Examples:')
        print('  python3 scripts/create_chapters.py lord-of-mysteries')
        print('  python3 scripts/create_chapters.py lord-of-mysteries 10')
